...
**Warning**
By default connection is secure. If you don't want to use SSL (TLS) connection, pass _secure: false_
...
To execute queries in transaction, you can use _transactional()_ method on _connection_ or _pool_ object
Example:
...
There is separate **logging** branch of mysql_driver. This branch will stay in sync with **main** branch of this repository, with one main difference - it has logging enabled.
